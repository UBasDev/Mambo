...
@Component({
  selector: 'app-sign-up-privacy-policy',
  standalone: true,
  ...
  template: `
    <div>
      ...
      <p>
        ...
        of Mambo's Website, located at mambo.com
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Mambo if you do not agree to take all
      ...
      <p><b>Cookies</b></p>
      <p>
        We employ the use of cookies. By accessing Mambo, you agreed to use
        cookies in agreement with the Mambo's Privacy Policy.
      </p>
      ...
      <p><b>License</b></p>
      <p>
        Unless otherwise stated, Mambo and/or its licensors own the intellectual
        property rights for all material on Mambo. All intellectual property
        rights are reserved. You may access this from Mambo for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Mambo</li>
        <li>Sell, rent or sub-license material from Mambo</li>
        <li>Reproduce, duplicate or copy material from Mambo</li>
        <li>Redistribute content from Mambo</li>
        <li>This Agreement shall begin on the date hereof.</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Mambo
        ...
        of Mambo,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Mambo shall not be liable for the Comments
      ...
      <p>
        Mambo reserves the right to monitor all Comments and to remove any
      ...
      <ul>
        ...
        <li>
          You hereby grant Mambo a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Mambo; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Mambo. Please include your name, your organization name,
      ...
      <ul>
        ...
        <li>
          No use of Mambo's logo or other artwork will be allowed for linking
      ...
      <p><b>Removal of links from our website</b></p>
      <p>
      ...
      <div class="flex items-center justify-center lg:justify-end">
        <button
          (click)="this.closePrivacyPolicyDialog()"
          pButton
          pRipple
  ...
  `,
  styleUrl: './SignUpPrivacyPolicy.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SignUpPrivacyPolicyComponent {
  private readonly dialogService = inject(DialogService);
  public closePrivacyPolicyDialog() {
    if (this.dialogService.dialogComponentRefMap.size > 0)
      this.dialogService.dialogComponentRefMap.forEach((dialogComponent) => {
